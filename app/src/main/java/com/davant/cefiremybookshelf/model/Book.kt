package com.davant.cefiremybookshelf.model
...
fun getInitialBooks() =
    listOf(
        ...
        Book("Aprendiz de asesino", "Robin Hobb", 1995, "9788496208511", "aprendiz_de_asesino", false, false),
        Book("El ojo del mundo", "Robert Jordan", 1991, "9788498726143", "el_ojo_del_mundo", false, false),
